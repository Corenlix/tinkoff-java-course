...
public class Subscription extends TableImpl<SubscriptionRecord> {
    ...
    public List<ForeignKey<SubscriptionRecord, ?>> getReferences() {
        return Arrays.asList(Keys.SUBSCRIPTION__FK_SUBSCRIPTION_CHAT, Keys.SUBSCRIPTION__FK_SUBSCRIPTION_LINK);
    }
    ...
    public Chat chat() {
        if (_chat == null)
            _chat = new Chat(this, Keys.SUBSCRIPTION__FK_SUBSCRIPTION_CHAT);
    ...
    public Link link() {
        if (_link == null)
            _link = new Link(this, Keys.SUBSCRIPTION__FK_SUBSCRIPTION_LINK);
