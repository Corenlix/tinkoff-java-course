...
public class LinkRecord extends UpdatableRecordImpl<LinkRecord> implements Record4<Long, String, OffsetDateTime, JSON> {
     ...
     */
    public void setContentJson(@Nullable JSON value) {
        set(3, value);
    }
    ...
    @Override
    @NotNull
    public Row4<Long, String, OffsetDateTime, JSON> valuesRow() {
    ...
    @Override
    @NotNull
    public LinkRecord values(@NotNull Long value1, @NotNull String value2, @NotNull OffsetDateTime value3, @Nullable JSON value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
    ...
    public LinkRecord(@NotNull Long id, @NotNull String url, @NotNull OffsetDateTime updatedAt, @Nullable JSON contentJson) {
        super(Link.LINK);
    ...
    public LinkRecord(ru.tinkoff.edu.java.scrapper.domain.jooq.tables.pojos.Link value) {
        ...
        if (value != null) {
            ...
            setContentJson(value.getContentJson());
        }
    }
}
