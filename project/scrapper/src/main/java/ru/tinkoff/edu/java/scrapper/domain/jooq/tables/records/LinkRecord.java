...
public class LinkRecord extends UpdatableRecordImpl<LinkRecord> implements Record4<Long, String, LocalDateTime, JSON> {
    ...
    @Override
    @NotNull
    public Row4<Long, String, LocalDateTime, JSON> valuesRow() {
    ...
    @Override
    @NotNull
    public LinkRecord values(@NotNull Long value1, @NotNull String value2, @NotNull LocalDateTime value3, @Nullable JSON value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
    ...
    public LinkRecord(@NotNull Long id, @NotNull String url, @NotNull LocalDateTime updatedAt, @Nullable JSON contentJson) {
        super(Link.LINK);
